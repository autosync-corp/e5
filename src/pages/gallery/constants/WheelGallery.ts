export const WHEEL_GALLERY_BANNER = "/assets/images/wheel-gallery-banner.png";
export const E5_FORGED_GALLERY_BANNER = "/assets/images/e5-forged-gallery-banner.png";
export const FORM_FORGED_SOLO_BLACK = "/assets/images/form-forged-solo-black.png";
export const SPEEDWAY_LOGO = "/assets/images/speedway-logo.png";
export const GALLERY_LOGO = "/assets/images/gallery-logo.png";
export const FORM_FORGED_SERIES_LOGO = "/assets/images/form-forged-series-logo.png";
