...
<template>
  <button
    ...
    :class="{
      ...
      'bg-white text-e5-red font-sans border-2 border-e5-red px-6 py-3 text-[14px] tracking-[5.6px] cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-lg': props.secondary,
